...
/** @type {string} */
const CACHE_VERSION = '1783230902|6083102143';
/** @type {string} */
const CACHE_PREFIX = 'cebollin_3d_test-sw-cache-';
...
/** @type {string[]} */
const CACHEABLE_FILES = ["index.wasm","index.pck","index.side.wasm","libterrain.web.release.wasm32.wasm"];
